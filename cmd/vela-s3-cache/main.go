...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/log_level,/vela/secrets/s3_cache/log_level"),
			Name:     "log.level",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/action,/vela/secrets/s3_cache/config/action"),
			Name:     "config.action",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/root,/vela/secrets/s3_cache/root"),
			Name:     "root",
			Usage:    "name of the s3 bucket",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_PREFIX"},
			FilePath: string("/vela/secrets/parameter/prefix,/vela/secrets/s3_cache/prefix"),
			Name:     "prefix",
			Usage:    "path prefix for all cache default paths",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_FILENAME"},
			FilePath: string("/vela/secrets/parameter/filename,/vela/secrets/s3_cache/filename"),
			Name:     "filename",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/path,/vela/secrets/s3_cache/path"),
			Name:     "path",
			Usage:    "path to store the cache file",
		},
		&cli.StringSliceFlag{
			EnvVars:  []string{"PARAMETER_MOUNT"},
			FilePath: string("/vela/secrets/parameter/mount,/vela/secrets/s3_cache/mount"),
			Name:     "mount",
			Usage:    "list of files/directories to cache",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_FLUSH_AGE"},
			FilePath: string("/vela/secrets/parameter/age,/vela/secrets/s3_cache/age"),
			Name:     "age",
			Usage:    "flush cache files older than # days",
		},
		&cli.DurationFlag{
			EnvVars:  []string{"PARAMETER_TIMEOUT"},
			FilePath: string("/vela/secrets/parameter/timeout,/vela/secrets/s3_cache/timeout"),
			Name:     "timeout",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/server,/vela/secrets/s3_cache/config/server"),
			Name:     "config.server",
			Usage:    "s3 server to store the cache",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_ACCELERATED_ENDPOINT", "CACHE_S3_ACCELERATED_ENDPOINT"},
			FilePath: string("/vela/secrets/parameter/config/accelerated_endpoint,/vela/secrets/s3_cache/config/accelerated_endpoint"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/access_key,/vela/secrets/s3_cache/config/access_key"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/secret_key,/vela/secrets/s3_cache/config/secret_key"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/config/session_token,/vela/secrets/s3_cache/config/session_token"),
			Name:     "config.session-token",
			Usage:    "s3 session token",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_REGION", "CACHE_S3_REGION"},
			FilePath: string("/vela/secrets/parameter/config/region,/vela/secrets/s3_cache/config/region"),
			Name:     "config.region",
			Usage:    "s3 region for the region of the bucket",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_CA_CERT", "CACHE_S3_CA_CERT"},
			FilePath: string("/vela/secrets/parameter/config/ca_cert,/vela/secrets/s3_cache/config/ca_cert"),
			Name:     "config.ca-cert",
			Usage:    "ca cert to connect to s3 server",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_CA_CERT_PATH", "CACHE_S3_CA_CERT_PATH"},
			FilePath: string("/vela/secrets/parameter/config/ca_cert_path,/vela/secrets/s3_cache/config/ca_cert_path"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/parameter/repo/owner,/vela/secrets/s3_cache/repo/owner"),
			Name:     "repo.owner",
			Usage:    "repository owner",
		},
		&cli.StringFlag{
			EnvVars:  []string{"REPOSITORY_NAME"},
			FilePath: string("/vela/secrets/parameter/repo/name,/vela/secrets/s3_cache/repo/name"),
			Name:     "repo.name",
			Usage:    "repository name",
		},
		&cli.StringFlag{
			EnvVars:  []string{"REPOSITORY_BRANCH"},
			FilePath: string("/vela/secrets/parameter/repo/branch,/vela/secrets/s3_cache/repo/branch"),
			Name:     "repo.branch",
